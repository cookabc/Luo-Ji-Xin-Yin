...
“第一例表示推论对而前题假，结论真而且对;第二例表示前题假、推论对、结 论假，但对。二例合共起来表示，如果前题假而推论对，那么结论有时真，有时 假;但一定对。所以推论对时，前题即使是假的，结论一定是对的。
